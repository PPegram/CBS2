...
# Update the main Flask app to use mock Gemini for demo purposes
simplified_app_py = '''"""
...
with open('app_simplified.py', 'w') as f:
    f.write(simplified_app_py)

print("✅ Created app_simplified.py - Hackathon-focused Flask app with built-in frontend")